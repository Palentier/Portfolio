        ...
        <div className="left-landing font-black text-4xl">
          ...
          <div className="flex">
            <Link href="https://discord.gg/k2FEGjxqN2">
              <Image width={40} height={40} src="/icons8-discord-new-50.png" draggable="false"/>
            </Link>
            <Link href="https://github.com/palentier">
              <Image width={40} height={40} src="/icons8-github-64.png" draggable="false"/>
            </Link>
            <Link href="https://twitter.com/palentier_">
              <Image width={40} height={40} src="/icons8-twitter-30.png" draggable="false"/>
            </Link>
          </div>
        </div>
